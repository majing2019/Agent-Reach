# -*- coding: utf-8 -*-
"""Walmart — product search and details via ecommerce-cli (Playwright)."""

from .base import Channel
from ..probe import probe_command


class WalmartChannel(Channel):
    name = "walmart"
    description = "Walmart 商品搜索、详情与评论（ecommerce-cli）"
    ...
    def check(self, config=None):
        ...
        result = probe_command("ecommerce-cli", ["check", "walmart"], timeout=30, package="ecommerce-cli")
